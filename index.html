        ...
        <section id="graficos" class="page">
            ...
            <div class="card">
                ...
                <div style="text-align:center; margin-top:10px; font-size:0.85rem; color:var(--secondary-color);">
                    <p>O GRÁFICO EXIBE A RELAÇÃO DE CUSTOS E LUCRO SOBRE O FATURAMENTO.</p>
                </div>
            </div>
        </section>
            ...
            <div class="card">
                <form id="formOperacao">
                    ...
                    <div class="form-grid">
                        ...
                        <!-- CAMPO ADIANTAMENTO ADICIONADO -->
                        <div class="form-group">
                            <label for="operacaoAdiantamento" style="color:var(--primary-color);">ADIANTAMENTO (R$):</label>
                            <input type="number" id="operacaoAdiantamento" step="0.01" min="0" placeholder="0,00">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <!-- Step 0.1 para aceitar frações -->
                            <input type="number" id="operacaoKmRodado" min="0" step="0.1">
                        </div>
